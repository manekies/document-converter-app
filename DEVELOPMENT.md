...
```bash
git remote add encore encore://document-converter-app-5cri
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/document-converter-app-5cri/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/document-converter-app-5cri/settings/integrations/github)
