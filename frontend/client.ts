...
export function Environment(name: string): BaseURL {
    return `https://${name}-document-converter-app-5cri.encr.app`
}
...
/**
 * Client is an API client for the document-converter-app-5cri Encore application.
 */
export class Client {
    public readonly document: document.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.document = new document.ServiceClient(base)
    }
 ...
 */
import { batchProcess as api_document_batch_process_batchProcess } from "~backend/document/batch_process";
import { batchProcessStream as api_document_batch_stream_batchProcessStream } from "~backend/document/batch_stream";
import { compare as api_document_compare_compare } from "~backend/document/compare";
import { convert as api_document_convert_convert } from "~backend/document/convert";
import { get as api_document_get_get } from "~backend/document/get";
import { list as api_document_list_list } from "~backend/document/list";
import { listOutputs as api_document_list_outputs_listOutputs } from "~backend/document/list_outputs";
import { getDashboard as api_document_metrics_getDashboard } from "~backend/document/metrics";
import { previewHtml as api_document_preview_previewHtml } from "~backend/document/preview";
import { process as api_document_process_process } from "~backend/document/process";
import {
...
import { listMatchingTemplates as api_document_templates_list_listMatchingTemplates } from "~backend/document/templates_list";
...
export namespace document {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.listMatchingTemplates = this.listMatchingTemplates.bind(this)
         ...
         */
        public async batchProcess(params: RequestType<typeof api_document_batch_process_batchProcess>): Promise<ResponseType<typeof api_document_batch_process_batchProcess>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/documents/batch/process`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_batch_process_batchProcess>
        }

        public async batchProcessStream(params: RequestType<typeof api_document_batch_stream_batchProcessStream>): Promise<StreamIn<StreamResponse<typeof api_document_batch_stream_batchProcessStream>>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                convertTo:      params.convertTo === undefined ? undefined : String(params.convertTo),
                documentIds:    params.documentIds.map((v) => v),
                fontFamily:     params.fontFamily,
                languages:      params.languages?.map((v) => v),
                mode:           params.mode === undefined ? undefined : String(params.mode),
                processingMode: params.processingMode === undefined ? undefined : String(params.processingMode),
                template:       params.template,
            })

            return await this.baseClient.createStreamIn(`/documents/batch/stream`, {query})
        }

        /**
         * Computes a diff visualization and similarity metrics between two documents.
         */
        public async compare(params: RequestType<typeof api_document_compare_compare>): Promise<ResponseType<typeof api_document_compare_compare>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/document/compare`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_compare_compare>
        }

        /**
         * Converts a processed document to the specified format.
         */
        public async convert(params: RequestType<typeof api_document_convert_convert>): Promise<ResponseType<typeof api_document_convert_convert>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/document/convert`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_convert_convert>
        }

        /**
         * Creates a new document matching template.
         */
        public async createTemplate(params: RequestType<typeof api_document_templates_create_createTemplate>): Promise<ResponseType<typeof api_document_templates_create_createTemplate>> {
            // Now make the actual call to the API
         ...
         */
        public async deleteTemplate(params: { templateId: string }): Promise<ResponseType<typeof api_document_templates_delete_deleteTemplate>> {
            // Now make the actual call to the API
        ...
        public async get(params: { id: string }): Promise<ResponseType<typeof api_document_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/document/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_get_get>
        }

        /**
         * Returns aggregated processing metrics for dashboards.
         */
        public async getDashboard(): Promise<ResponseType<typeof api_document_metrics_getDashboard>> {
            // Now make the actual call to the API
         ...
         */
        public async getTemplate(params: { templateId: string }): Promise<ResponseType<typeof api_document_templates_get_getTemplate>> {
            // Now make the actual call to the API
         ...
         */
        public async listMatchingTemplates(): Promise<ResponseType<typeof api_document_templates_list_listMatchingTemplates>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/document-templates`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_templates_list_listMatchingTemplates>
        }

        /**
         * Lists exported outputs for a document.
         */
        public async listOutputs(params: { documentId: string }): Promise<ResponseType<typeof api_document_list_outputs_listOutputs>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/document/${encodeURIComponent(params.documentId)}/outputs`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_list_outputs_listOutputs>
        }

        /**
         * Lists available export templates (built-in + custom).
         */
        public async listTemplates(): Promise<ResponseType<typeof api_document_templates_listTemplates>> {
            // Now make the actual call to the API
         ...
         */
        public async previewHtml(params: RequestType<typeof api_document_preview_previewHtml>): Promise<ResponseType<typeof api_document_preview_previewHtml>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                mode:     params.mode === undefined ? undefined : String(params.mode),
                template: params.template,
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/document/${encodeURIComponent(params.id)}/preview`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_preview_previewHtml>
        }
        ...
        public async process(params: RequestType<typeof api_document_process_process>): Promise<ResponseType<typeof api_document_process_process>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/document/${encodeURIComponent(params.documentId)}/process`, {method: "POST", body: JSON.stringify(body)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_process_process>
        }

        /**
         * Performs spellchecking and light grammar correction in the specified language (or autodetected).
         */
        public async spellcheck(params: RequestType<typeof api_document_spellcheck_spellcheck>): Promise<ResponseType<typeof api_document_spellcheck_spellcheck>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/nlp/spellcheck`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_spellcheck_spellcheck>
        }

        /**
         * Translates text to the target language, preserving formatting as best-effort.
         */
        public async translate(params: RequestType<typeof api_document_translate_translate>): Promise<ResponseType<typeof api_document_translate_translate>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/nlp/translate`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_translate_translate>
        }

        /**
         * Updates the extracted text and/or structure for a document, creating a new version.
         */
        public async updateDocument(params: RequestType<typeof api_document_update_updateDocument>): Promise<ResponseType<typeof api_document_update_updateDocument>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
                documentStructure: params.documentStructure,
         ...
         */
        public async updateTemplate(params: RequestType<typeof api_document_templates_update_updateTemplate>): Promise<ResponseType<typeof api_document_templates_update_updateTemplate>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
         ...
         */
        public async upload(params: RequestType<typeof api_document_upload_upload>): Promise<ResponseType<typeof api_document_upload_upload>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/document/upload`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_upload_upload>
        }

        /**
         * Creates or updates a custom template.
         */
        public async upsertTemplate(params: RequestType<typeof api_document_templates_upsertTemplate>): Promise<ResponseType<typeof api_document_templates_upsertTemplate>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/templates`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_document_templates_upsertTemplate>
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "document-converter-app-5cri-Generated-TS-Client (Encore/v1.49.1)";
        }
